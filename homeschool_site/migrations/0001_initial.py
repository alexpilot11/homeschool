    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(related_query_name='user', to='auth.Group', help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', blank=True, verbose_name='groups')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_visible_by_unreg', models.BooleanField()),
            ],
        ),
    ]
